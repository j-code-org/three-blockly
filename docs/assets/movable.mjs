...
Movable.prototype.setColor = function(){};
Movable.prototype.setTransparent = function(){};
// 大きさ
Movable.prototype.setScale = function( s ) {
  this.scale.set( s, s, s );
  return this;
}
// 速さ
Movable.prototype.setSpeed = function( s ) {
	this.speed = s;
  return this;
}

// 前に d センチうごかす
Movable.prototype.moveForward = function(d) {
	var mesh = this;
...
// 右に d 度まがる(アニメ無し)
Movable.prototype.turnRight = function(d) {
	var mesh = this;
	return new Promise(function (resolve, reject) {
		//全体を右に曲げる
...
// 上に d 度まがる(アニメ無し)
Movable.prototype.lookUpward = function (d) {
	var mesh = this;
	return new Promise(function (resolve, reject) {
		setTimeout(function(){
			resolve();
