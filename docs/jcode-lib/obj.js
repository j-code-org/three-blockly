...
Blockly.Blocks['function_declaration'] = {
  ...
  decompose: function(workspace) {
    var containerBlock = workspace.newBlock('function_mutatorcontainer');
    ...
    for (var i = 0; i < this.arguments_.length; i++) {
      var paramBlock = workspace.newBlock('function_mutatorarg');
      paramBlock.initSvg();
